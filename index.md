...
エッセイ「人間活動の10分類」です。下記から言語を選んでください！

Welcome to the Human Behavior book project. Choose your language:

## Languages / 言語

- **[日本語版]({{ site.baseurl }}/ja/)**  ←　ここをクリック！
- **[English version]({{ site.baseurl }}/en/)** 　←　Click here!

---

このエッセイは人間活動の原理について探索するオープンソースプロジェクトです。このエッセイは日本語と英語両方で利用できます。  
