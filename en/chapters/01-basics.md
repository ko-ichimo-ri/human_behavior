...
## What to Think About and Its Usefulness
...
## The Structure of Human Activity: Agent, Input/Output, and Processing
...
The "characters" are of three types: "agent," "input/output," and "processing." By dividing this "input/output" and "processing" into 3 types each, and designating one as the "axis" and the other as "results," we can divide them into 18 ($` =3^2 \times 2 `$) types in a MECE manner. By excluding ineffective ones and grouping some into the same classification, we reduce this to 10 types, which I will discuss later.
...
## Three Types of Modifiable Entities: Objects, Individuals, and Society
...
## Axis and Results: Validity and Development
...
## 10-fold Classification of Human Activity

Based on the discussion above, let me classify human activity exhaustively without omission or overlap. This is what we call MECE. This section only confirms the names and checks that it's MECE. Details of each activity are discussed in [Various Discussion of Human Activity](#various-discussion-of-human-activity).
...
## Subsidiary Benefits of the 10-fold Classification
...
Detailed topics touched on in this chapter are described in [Advanced Edition](https://ko-ichimo-ri.github.io/human_behavior/en/chapters/02-advanced.html). In [How to Live in the AI and Robot Age](https://ko-ichimo-ri.github.io/human_behavior/en/chapters/03-ai-robots.html), we'll discuss how to live in the AI and robot age based on [Fundamentals](https://ko-ichimo-ri.github.io/human_behavior/en/chapters/01-basics.md) and [Advanced Edition](https://ko-ichimo-ri.github.io/human_behavior/en/chapters/02-advanced.html).

The essay I started writing before refining this idea is [here](https://github.com/ko-ichimo-ri/poem/blob/main/human_behavior/essay.md). It ended up incomplete because I couldn't organize my thoughts well, but there are lots of ideas. I also have [notes](https://github.com/ko-ichimo-ri/poem/blob/main/human_behavior/memo/strategy.md) at about the memo level. It's not something people can easily read, but if you're interested, please do.

Finally. This text has no citations or references. Frankly, its value as an academic paper is limited. However, I believe this idea will become philosophically significant through refinement. If you felt any value in the "10-fold Classification of Human Activity" described in this text, I would appreciate your collaboration. I'd be delighted to receive pull requests on [GitHub](https://github.com/ko-ichimo-ri/human_behavior), etc.
...
- Classify "scholarship" into MECE based on the "classification of human activity" to make it easier to start studying.
- What is existence? It is what mediates between "agent" and "input/output" or between "agent" and "processing."
  - Chocolate on a desk physically doesn't change unless moved, but my chocolate changes with just agreement!
  - The difference between virtual and real. Virtual servers and physical servers, etc.
  - The difference between virtual and symbolic. Virtual addresses and currency, etc.
  - And so on.
- Classification of language and rules, numerals, and reasons.
  - Rhetoric has two types: literature and argumentation, and logic is only mathematical proof. Don't conflate high school Japanese essays with mathematical proof!
  - When reduced to elements, existence yields six types: law, ideas, norms, logic, technique, and etiquette.
  - Good with numbers also has 6 types. Reasons also have 6 types.
  - And so on.
- Can we assign "development" to "objects" by considering the absence of "development" as a type of "development"?
  - Assigning "development" to "objects" "input/output" through constant retention and ignoring.
  - The hint is in Zhuangzi; should we call assigning "development" to "objects'" "input/output" "making all things equal," and assigning "development" to "objects'" "processing" "free wandering"?
- Ways to combine human activities.
  - Social science and religion can be explained as combinations of human activities.
  - Nested structures, reassignment, ratios of validity and development, vertical and horizontal connections, etc.
  - Are there types like programming languages?
- How to formalize this text?
  - What is the relationship between things like "technology" and "scholarship" where "input/output" and "processing" are swapped?
  - What is the relationship between things like "technology" and "culture" where "validity" and "development" are swapped?
- Misunderstandings about uncertainty principle and incompleteness theorem

## Related Pages

Main text
- [Advanced Edition](https://ko-ichimo-ri.github.io/human_behavior/en/chapters/02-advanced.html)
- [How to Live in the AI and Robot Age](https://ko-ichimo-ri.github.io/human_behavior/en/chapters/03-ai-robots.html)

Before refinement
- [Notes](https://github.com/ko-ichimo-ri/poem/blob/main/human_behavior/memo/strategy.md)
- [Incomplete Essay](https://github.com/ko-ichimo-ri/poem/blob/main/human_behavior/essay.md)

[^math]: Math experts might prefer axioms and rules of inference, but I prioritized understandability and familiarity in how I explained it.

[^math_beautiful]: Of course, there can be different proofs even if truth value is the same. If focusing on beauty or elegance of calculation, you might interpret changeable things as 1 or more. That's context-dependent. Details are in the same section as this note.

[^correctness]: I use "retain" and "adopt" for known things, "adopt" and "ignore" for unknown things.

[^model]: I think studying the relationship between proof theory and semantics in mathematical logic will help you understand.
